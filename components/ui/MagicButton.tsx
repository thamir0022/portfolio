...
const MagicButton = ({
  ...
  return (
    <button type={type ? type : "button"} onClick={handleClick} disabled={disabled} className="w-full rounded-lg relative inline-flex h-12 overflow-hidden p-[1px] focus:outline-none md:w-60 md:mt-10">
